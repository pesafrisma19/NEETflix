            ...
            >
              ...
              >
                ...
                <img
                  ...
                  onClick={() => navigate(`/comic/${item.id}`)}
                ...
                <div className="flex flex-col ml-4 space-y-2">
                  ...
                  <div className="flex items-center gap-x-2 w-full overflow-hidden">
                    <div className="text-gray-400 text-[13px] text-nowrap overflow-hidden text-ellipsis flex items-center gap-x-1 capitalize">
                    ...
                    <div className="text-gray-400 text-[13px] text-nowrap overflow-hidden text-ellipsis flex items-center gap-x-1">
